...
#define Z_MIN_ENDSTOP_INVERTING ENABLED(CR10V3_BLTOUCH) // Set to true to invert the logic of the endstop.
#define X_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Y_MAX_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop.
#define Z_MAX_ENDSTOP_INVERTING ENABLED(CR10V3_BLTOUCH) // Set to true to invert the logic of the endstop.
